...
def main():
    ...
    for seed in [207,522,503,511,116,504,770,694,977,710 ,513,411,381,280,333,774,60,449,728,673,512,249,173,658,656,356,753,217]:

        gc = GridConfig(size=5, num_agents=3, seed=seed, density=0.3, obs_radius=5, max_episode_steps=16)
